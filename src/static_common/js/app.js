...
App.config(function($stateProvider, $urlRouterProvider) {
  ...
  state('admin-dashboard', {
    ...
    resolve: {
      ...
      depsAdminDashboard: ['$ocLazyLoad', function($ocLazyLoad) {
                    ...
                    //get client list
              Client: function(depsAdminDashboard, apiService, authenticationSvc) {
  ...
  state('admin-reader', {
   ...
   state('admin-backdoor-reader', {
    url: '/admin-backdoor-reader/:type/:object_id',
  
    templateUrl: '/static/views/Admin/BackdoorReader.html',
    controller: 'AdminBackdoorReaderController',
    resolve: {
      auth: function($q, authenticationSvc) {
      ...
      depsAdminQuote: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            ...
                            files: [
                                ...
                                'https://cdnjs.cloudflare.com/ajax/libs/moment-timezone/0.5.11/moment-timezone-with-data.min.js',
                                'https://cdnjs.cloudflare.com/ajax/libs/angular-moment/1.0.1/angular-moment.min.js',
                                '/static/js/controllers/admin-backdoor-reader.js',
  ...
  state('amp', {
    ...
    url: '/amp',
    templateUrl: '/static/views/Home/amp.html',
    ...
    resolve: {
      ...
      depsAMP: ['$ocLazyLoad', 'depsSuccess', function($ocLazyLoad, depsSuccess) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
                            serie: true,
                            files: [
  ...
  state('partnership', {
    ...
    url: '/partnership',
    templateUrl: '/static/views/Home/partnership.html',
    ...
    resolve: {
      ...
      depsPartnership: ['$ocLazyLoad', 'depsSuccess', function($ocLazyLoad, depsSuccess) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
                            serie: true,
                            files: [
                              ...
                              '/static/js/controllers/partnership.js',
      ...
      depsHistory: ['$ocLazyLoad', 'depsSuccess', function($ocLazyLoad, depsSuccess) {
          return $ocLazyLoad.load({
              ...
              files: [
                ...
                '/static/js/services/executiveService.js',
                '/static/js/services/ajaxService.js',
                '/static/js/controllers/search_tool.js',
              ]
          });
      }],
