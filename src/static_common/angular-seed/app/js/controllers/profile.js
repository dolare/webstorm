...
controller('ProfileController',
  function(avatarService, $timeout, ajaxService, $filter, tableDataService, List, $scope, $location, $window, $http, authenticationSvc, $cookies, $state) {

    var token = authenticationSvc.getUserInfo().accessToken;
    $scope.username = List.profile.username;
...
// console.log(decodedString); // Outputs: "Hello World!"
    ...
    $scope.viewsubuser = function($index) {
      $scope.subuserdetail = {
...
$scope.submitpassword = function() {
    ...
    $scope.submit = function() {
      ...
      //need to be changed to api/auth/
      $http({
          url: '/api/auth/',
          method: 'POST',
          data: {
        ...
        .then(function(result) {
          ...
          if ($scope.newpw1 === $scope.newpw2 && $scope.newpw2 === $scope.oldpw) {
            ...
            $.notify({
              ...
              // options
              icon: "fa fa-times",
              message: 'Please re-enter a different password.'
            }, {
              // settings
              type: 'danger',
              placement: {
            ...
            console.log("Please re-enter a different password");
            // $scope.message = "Please re-enter a different password";
            $scope.messageHid = false;
            //reset
            $scope.oldpw = "";
            $scope.newpw1 = "";
            $scope.newpw2 = "";
            ...
            $http({
              ...
              data: {
                "new_password1": $scope.newpw1,
                "new_password2": $scope.newpw2
              }
              ...
              jQuery('#pwModal').modal('toggle');
                ...
                console.log('an error occurred...' + JSON.stringify(error));
                $scope.message = "The passwords do no match, password change fail";
                $.notify({
          ...
          $scope.message = "Your old password is incorrect";
          $scope.messageHid = false;
          $.notify({
